...
{
    enum class MAP_TYPE { DEFAULT = 0, RANDOM = 1, EMPTY = 2, SAVED };

    enum class THEME { STONE, DIRT };

    enum class OBJECT { WALL_OUT = -1, VOID = 0, WALL_IN = 1, BOX = 2, BOMB = 3, PLAYER = 4, LAVA = 5 };

    enum class MAP_STATE { DEFAULT, TRANSPARENT };
