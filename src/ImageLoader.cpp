...
// a chaque fois que je vois ce pavé j'ai envie de me tirer une balle.
const std::vector<std::string> Indie::ImageLoader::paths = {
    ...
    "../ressources/images/multi1/Check_idle.png",
    "../ressources/images/multi1/Check_pressed.png",
    "../ressources/images/multi1/Check_selected.png",
    "../ressources/images/multi1/Check_tick.png",
    "../ressources/images/multi1/IA_idle.png",
    "../ressources/images/multi1/IA_selected.png",
    "../ressources/images/multi1/IA_pressed.png",
    "../ressources/images/multi1/Layout.png",
    "../ressources/images/multi1/Niveau_idle.png",
    "../ressources/images/multi1/Niveau_pressed.png",
    "../ressources/images/multi1/Niveau_selected.png",
    "../ressources/images/multi1/Retour_idle.png",
    "../ressources/images/multi1/Retour_pressed.png",
    "../ressources/images/multi1/Retour_selected.png",
    "../ressources/images/multi1/Suivant_idle.png",
    "../ressources/images/multi1/Suivant_pressed.png",
    "../ressources/images/multi1/Suivant_selected.png",
    "../ressources/images/multi1/Temps_idle.png",
    "../ressources/images/multi1/Temps_pressed.png",
    "../ressources/images/multi1/Temps_selected.png",
    "../ressources/images/multi1/Theme_idle.png",
    "../ressources/images/multi1/Theme_pressed.png",
    "../ressources/images/multi1/Theme_selected.png",
    "../ressources/images/multi1/title.png",
    "../ressources/images/multi2/Jouer_idle.png",
    "../ressources/images/multi2/Jouer_pressed.png",
    "../ressources/images/multi2/Jouer_selected.png",
    "../ressources/images/multi2/KB_tick.png",
    "../ressources/images/multi2/Layout.png",
    "../ressources/images/multi2/P1KB_bomb_idle.png",
    "../ressources/images/multi2/P1KB_bomb_pressed.png",
    "../ressources/images/multi2/P1KB_bomb_selected.png",
    "../ressources/images/multi2/P1KB_bomb_tick.png",
    "../ressources/images/multi2/P1KB_down_idle.png",
    "../ressources/images/multi2/P1KB_down_pressed.png",
    "../ressources/images/multi2/P1KB_down_selected.png",
    "../ressources/images/multi2/P1KB_down_tick.png",
    "../ressources/images/multi2/P1KB_left_idle.png",
    "../ressources/images/multi2/P1KB_left_pressed.png",
    "../ressources/images/multi2/P1KB_left_selected.png",
    "../ressources/images/multi2/P1KB_left_tick.png",
    "../ressources/images/multi2/P1KB_right_idle.png",
    "../ressources/images/multi2/P1KB_right_pressed.png",
    "../ressources/images/multi2/P1KB_right_selected.png",
    "../ressources/images/multi2/P1KB_right_tick.png",
    "../ressources/images/multi2/P1KB_up_idle.png",
    "../ressources/images/multi2/P1KB_up_pressed.png",
    "../ressources/images/multi2/P1KB_up_selected.png",
    "../ressources/images/multi2/P1KB_up_tick.png",
    "../ressources/images/multi2/P2KB_bomb_idle.png",
    "../ressources/images/multi2/P2KB_bomb_pressed.png",
    "../ressources/images/multi2/P2KB_bomb_selected.png",
    "../ressources/images/multi2/P2KB_bomb_tick.png",
    "../ressources/images/multi2/P2KB_down_idle.png",
    "../ressources/images/multi2/P2KB_down_pressed.png",
    "../ressources/images/multi2/P2KB_down_selected.png",
    "../ressources/images/multi2/P2KB_down_tick.png",
    "../ressources/images/multi2/P2KB_left_idle.png",
    "../ressources/images/multi2/P2KB_left_pressed.png",
    "../ressources/images/multi2/P2KB_left_selected.png",
    "../ressources/images/multi2/P2KB_left_tick.png",
    "../ressources/images/multi2/P2KB_right_idle.png",
    "../ressources/images/multi2/P2KB_right_pressed.png",
    "../ressources/images/multi2/P2KB_right_selected.png",
    "../ressources/images/multi2/P2KB_right_tick.png",
    "../ressources/images/multi2/P2KB_up_idle.png",
    "../ressources/images/multi2/P2KB_up_pressed.png",
    "../ressources/images/multi2/P2KB_up_selected.png",
    "../ressources/images/multi2/P2KB_up_tick.png",
    "../ressources/images/multi2/Perso1_idle.png",
    "../ressources/images/multi2/Perso1_pressed.png",
    "../ressources/images/multi2/Perso1_selected.png",
    "../ressources/images/multi2/Perso2_idle.png",
    "../ressources/images/multi2/Perso2_pressed.png",
    "../ressources/images/multi2/Perso2_selected.png",
    "../ressources/images/multi2/Retour_idle.png",
    "../ressources/images/multi2/Retour_pressed.png",
    "../ressources/images/multi2/Retour_selected.png",
    "../ressources/images/multi2/title.png",
    "../ressources/images/multi1/pUps.png",
    "../ressources/images/multi1/WhiteBG.png"
};
