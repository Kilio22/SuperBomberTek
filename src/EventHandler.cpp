...
bool Indie::EventHandler::isKeyPressed(irr::EKEY_CODE key)
{
...
bool Indie::EventHandler::isKeyPressedAtOnce(irr::EKEY_CODE key)
{
    if (key > irr::KEY_KEY_CODES_COUNT) {
        return false;
    }
...
bool Indie::EventHandler::isKeyReleased(irr::EKEY_CODE key)
{
    if (key > irr::KEY_KEY_CODES_COUNT) {
        return false;
    }
